export default function Footer() {
  return (
    <footer className="bg-bg-deep-black border-t border-bg-card-light py-12 mt-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-bold text-text-primary mb-4">Jokester</h3>
            <p className="text-sm text-text-secondary">Transform video moments into hilarious custom merchandise.</p>
          </div>
          <div>
        ...
        <div className="border-t border-bg-card-light pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-sm text-text-secondary">© 2024 Jokester. All rights reserved.</p>
